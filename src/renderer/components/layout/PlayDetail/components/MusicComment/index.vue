...
.commentHeaderBtn {
  ...
  cursor: pointer;
  background-color: var(--color-primary-light-100-alpha-180);
  border-radius: 50%;
  ...
  &:hover {
    ...
    background-color: var(--color-primary-light-100-alpha-260);
  }
}
.commentMain {
  flex: auto;
  background:
    linear-gradient(180deg, var(--color-primary-light-100-alpha-220), var(--color-primary-light-400-alpha-700));
  border: 1px solid var(--color-primary-light-100-alpha-250);
  border-radius: 18px;
  box-shadow:
